...
inline ErrorCode toErrorCode(TransferErrorCode ec) {
    switch (ec) {
        case TransferErrorCode::OK:                   return ErrorCode::NONE_ERROR;
        case TransferErrorCode::CANCELLED:            return ErrorCode::P2P_CONNECTOR_WORKER_READ_CANCELLED;
        case TransferErrorCode::TIMEOUT:              return ErrorCode::P2P_CONNECTOR_WORKER_READ_TIMEOUT;
        case TransferErrorCode::BUILD_REQUEST_FAILED: return ErrorCode::P2P_CONNECTOR_WORKER_HANDLE_READ_TRANSFER_FAILED;
        case TransferErrorCode::CONNECTION_FAILED:    return ErrorCode::P2P_CONNECTOR_WORKER_HANDLE_READ_TRANSFER_FAILED;
        case TransferErrorCode::RPC_FAILED:           return ErrorCode::P2P_CONNECTOR_WORKER_HANDLE_READ_TRANSFER_FAILED;
        case TransferErrorCode::BUFFER_MISMATCH:      return ErrorCode::P2P_CONNECTOR_WORKER_READ_BUFFER_MISMATCH;
        case TransferErrorCode::RDMA_FAILED:          return ErrorCode::P2P_CONNECTOR_WORKER_READ_TRANSFER_RDMA_FAILED;
        case TransferErrorCode::UNKNOWN:              return ErrorCode::P2P_CONNECTOR_WORKER_READ_FAILED;
        default:                                      return ErrorCode::P2P_CONNECTOR_WORKER_READ_FAILED;
    }
}
