...
__global__ void gather_copy_var_kernel(const void**  src_ptrs,
...
__global__ void scatter_copy_var_kernel(const void*   src,
...
void launch_gather_copy_var(const void**  src_ptrs,     // 源指针数组
...
void launch_scatter_copy_var(const void*   src,          // 源内存起始地址
