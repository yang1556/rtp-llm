...
def scaled_fp4_grouped_quant(
    ...
    # Use silu_and_mul_scaled_fp4_experts_quant with use_silu_and_mul=False
    # This will use the mask-based path (cvt_fp16_to_fp4_expert) which doesn't need offsets
    silu_and_mul_scaled_fp4_experts_quant(
        output.view(l * m, k // 2),
