...
class GetTopkRaggedCPTest(TestCase):
    ...
    def test_get_topk_ragged_cp_with_prefix_cache(self):
        ...
        ks = torch.arange(input_tokens, dtype=torch.int32, device=device) + prefix_length
        ke = torch.arange(1, input_tokens + 1, dtype=torch.int32, device=device) + prefix_length
