...
class AiterPrefillAttnOp:
    ...
    def forward(self, qkv, kv_cache, fmha_params):
        q_tensor = qkv[0]  # Packed Q: [total_q, head_num, head_dim]
        ...
        # Compute seqlen_k: prefix_lengths + input_lengths per sequence
        ...
        k_descale = None
        v_descale = None
        if k_cache.dtype in (torch.float8_e4m3fnuz, torch.float8_e4m3fn):
